          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
            {banners.map((b) => (
              ...
              >
                ...
                {/* Image Area */}
                <div className="aspect-[2.35/1] bg-slate-100 relative overflow-hidden">
                  <img 
            ...
            <div className="bg-white w-full max-w-lg rounded-[32px] shadow-2xl relative z-10 overflow-hidden animate-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
              ...
              <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-white shrink-0">
                <div>
                   ...
                   <p className="text-xs text-slate-400">ขนาดแนะนำ 21:9 (เช่น 1920x820 px)</p>
                </div>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-5 overflow-y-auto custom-scrollbar">
                ...
                <div className="space-y-2">
                  <div className="relative group">
                    <div 
                        className={`w-full aspect-[21/9] rounded-2xl border-2 border-dashed transition-all flex flex-col items-center justify-center overflow-hidden cursor-pointer relative
