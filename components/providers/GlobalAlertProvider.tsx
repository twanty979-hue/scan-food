...
// --- ✅ แก้ไขส่วน Icons ให้รับ Props className ได้ ---
const IconCheck = ({ className = "text-emerald-500" }: { className?: string }) => (
...
const IconInfo = ({ className = "text-blue-500" }: { className?: string }) => (
  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/>
  </svg>
);

const IconWallet = ({ className = "text-indigo-500" }: { className?: string }) => (
  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
